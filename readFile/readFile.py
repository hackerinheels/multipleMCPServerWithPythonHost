...
mcp = FastMCP("Read content of a file")


@mcp.tool("read_from_csv_file")
async def get_csv_file_content(file_path: str) -> List[Dict[str, str]]:
    """
